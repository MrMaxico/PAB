...
{
    public class GroundDetector : BaseDetector<GroundCheck>
    {
        [Header("Settings")]
        ...
        [Header("Timing")]
        [SerializeField] private float _groundedGracePeriod = 0.3f;
        ...
        protected override LayerMask DefaultLayerMask => _groundLayer;
        ...
        {
            var check = new GroundCheck(id, direction, distance, priority, type, radius, ResolveLayerMask(layerMask), triggerInteraction);
            RegisterCheck(check);
        }
        ...
        {
            return Time.time - _lastJumpTime < _groundedGracePeriod;
        }
